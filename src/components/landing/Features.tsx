...
const features = [
  ...
  },
  {
    ...
    description: 'Document your transformation with before and after photos to visualize your progress.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section ref={ref} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            Everything you need to track your weight loss journey effectively
          </motion.p>
        </div>
