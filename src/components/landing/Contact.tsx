...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-24 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-indigo-400 mb-4">Contact Information</h3>
              <p className="text-gray-300">
                Our team is here to help you with any questions about our platform, 
                subscription plans, or technical support.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">support@weighttracker.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">123 Health Street, Fitness City, FC 98765</p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
                >
